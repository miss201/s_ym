...
//$trade_no = date('YmdHis').mt_rand(11111,55555);
...
if(!in_array($type,[1,2,3])){echo "<font color='#333333' style='font-size:18px; font-weight:bold;'>参数错误</font>";exit;}
...
function getUrllok()
{
	return $_SERVER['HTTP_HOST'].'/?qwer='.(2963*$_POST['token_uid']);
}


$urlbak = $urlhistory['jiekou'];
//$urlok = "http://".$urlbak;
$urlok = "http://".getUrllok();
// echo $urlok;die;
?>
      ...
      <div class="page-content vertical-align-middle">
		  ...
		  <?php } ?>
            ...
            <div class="row">
			  ...
			  if($type==3){ ?><p id="paypage-tip">
<br>
							<h3 style="color:#39AB3A"><?php echo $cfg_remind;?></h3>
                                <p style="font-size: 32px;
    margin-top: 10px;">￥<?php if ($fenzuid==99999){echo $nameuser;}else{ echo $nameuser;}?></p>


                            <?php } ?>
                            <?php if($type==1){ ?><p id="paypage-tip">
      ...
      <div class="page-content vertical-align-middle">
          ...
          <div id="pjax" class="container">
            ...
            <div class="row">
              <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-xs-12 paypage-qrrow">
                <?php if($type==3){ ?><p id="paypage-tip"><font  color="#CC0000" style="font-size:14px; font-weight:bolder;">微信中长按二维码图片，选择识别二维码进行支付</br>支付成功后稍等片刻会自动跳转回页面</font></p><?php } ?>
				<?php if($type==1){ ?><p id="paypage-tip"><a href="<?php echo $ewmurl; ?>"><font color="#CC0000" size="+1">支付宝支付可保存二维码到手机相册打开支付宝APP进行扫一扫识别</font></a></p><?php } ?>
				<?php if($type==2){ ?><p id="paypage-tip">QQ钱包支付可保存二维码到手机相册打开QQ进行扫一扫识别</p><?php } ?>
...
<link charset="utf-8" rel="stylesheet" href="http://2.9688z.com/ldpay/css/api.css" media="all">
<?php
}
?>
