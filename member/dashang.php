...
<head>
  ...
  <style>
    .layui-col-md3 .layui-elem-quote
    {
    	border-left:none;
    }
  .layui-col-md3:nth-child(1) .layui-elem-quote
    {
    ...
    .layui-col-md3:nth-child(2) .layui-elem-quote
    {
    	background-color:#00BCD4;
        color:white;
    }
    
    .layui-col-md3:nth-child(3) .layui-elem-quote
    {
    	background-color:#8BC34A;
        color:white;
    }
    .layui-col-md3:nth-child(4) .layui-elem-quote
    {
