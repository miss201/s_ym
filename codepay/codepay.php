...
//$dataArr=json_decode(base64_decode($_POST['dataArr']),true);

//提交的用户  也可以去session或者cookie中取登录用户 $_SESSION['uid']
/* echo "<pre>";
var_dump(json_decode(base64_decode($_POST['dataArr']),true));
die;  */
$user = get_usershipin('uid',$_POST['id']);//提交的用户  也可以去session中取登录用户 $_SESSION['uid']
