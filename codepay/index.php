...
/*echo "<pre>";
var_dump(json_decode(base64_decode($_GET['data']),true));
die; */
/**
 * 充值示范页面
 * Created by codepay.
...
$username = '会员支付'; //   http://域名/codepay/?user=admin 访问则自动填写了账户信息
...
<head><title>
    ...
    <!--[if lt IE 9]>
    <script src="/codepay/js/html5shiv.min.js"></script>
    <script src="/codepay/js/respond.min.js"></script>
    <![endif]-->
</head>
<body>
<div id="loadingPicBlock" style="max-width: 720px;margin:0 auto;" class="pay">
    ...
    <div class="g-Total gray9"><h1>请选择一个充值方式（微信、支付宝）</h1></div>
    <section class="clearfix g-member">
        ...
        <form action="codepay.php" method="post">
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您选择充值： <?php echo $dataArr['price'];?>
                     
                    <input  type="hidden" name="dataArr" value="<?php echo $_GET['data'];?>"> 元
                    </li>
                    <li class="gray6"
                        style="width: 100%;padding: 5px 0px 0px 10px;display: <?php echo $codepay_config['userOff'] && $user ? 'none' : 'inline'; ?>;height: 50px;">
                        充值用户名： <?php echo $user; ?>   </li>
                    ...
                    <!-- <li paytype="2" class="gray9" type="codePay" style="width: 33%">
                        <a href="javascript:;"><img src="/codepay/img/qqpay.jpg"><s></s></a>
                    </li> -->
                </ul>
            </article>
