...
$t = explode('/', $ewm);
  ...
  ?>
<div class="qrcon">
<span>提醒：支付金额必须是 <b><?php if ($fenzuid==99999){echo $nameuser;}else{ echo $m;}?></b> 元才可观看</span>
<i><img    width="168"  id="qrcode_load"  src="/ewmimages/<?php if ($fenzuid==99999){echo $ewm;}else{ echo $ewm;}?>?v=<?php echo time();?>" ></i>
