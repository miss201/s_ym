...
if(empty($_SESSION['domain_time']))
{
	$_SESSION['domain_time'] = time();
  	$_SESSION['domain_num'] = 0;
}

if($_SESSION['domain_time'] +10 < time())
{
	$_SESSION['domain_time'] = time();
  	$_SESSION['domain_num']++;
}

if($_SESSION['domain_num'] >= $count_domain)
{
	$_SESSION['domain_num'] = 0;
}
...
//$site_domain = isset($domain[$_SESSION['domain_num']]) && $domain[$_SESSION['domain_num']]?$domain[$_SESSION['domain_num']]:$domain[rand(0,count($domain)-1)];
//var_dump($_SESSION['domain_time']);
//var_dump($_SESSION['domain_num']);
