...
<style>
body{ padding:0; margin:0; font-family: "微软雅黑", "宋体";background:black;}
...
var array = ["广东",
  ...
  "澳门"];
     ...
     <div id="float_div" style="width: 250px; text-align: center; height: 30px; position: relative; color: rgb(255, 255, 255); font-size: 16px; padding: 5px 10px; transition: all 0.5s ease 0s; top: 0px;"> 来自四川的用户打赏7元</div></div>
     <script>
     ...
     <div id="a1" style="margin: auto; background-color: rgb(0, 0, 0); width: 307px; height: 200px; cursor: pointer;"><video controls="controls" src="http://shang.jisu668.com/Public/Upload/ad/59831028ce5b1.gif" id="ckplayer_a1" width="100%" height="200" loop="loop" poster="http://xyz.1ady.cn/freevideo/freevideo.gif" webkit-playsinline=""></video></div>
